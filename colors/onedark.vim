...
if &diff
  ...
  call s:h("CursorLine", { "bg": s:cursor_grey, "gui" : "bold" }) " the screen line that the cursor is in when 'cursorline' is set
endif
...
call s:h("CursorLineNr", { "gui" : "bold" }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
call s:h("MatchParen", { "fg": s:red, "gui": "underline,bold" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
...
call s:h("SpellBad", { "fg": s:red, "gui": "underline,bold", "cterm": "underline" }) " Word that is not recognized by the spellchecker. This will be combined with the highlighting used otherwise.
call s:h("SpellCap", { "fg": s:dark_yellow, "gui" : "underline,bold" }) " Word that should start with a capital. This will be combined with the highlighting used otherwise.
